...
export default function (id) {
  ...
  var slider = document.getElementById(id) as HTMLElement;
  ...
  // get some properties
  var min = parseFloat(slider.getAttribute("se-min") as string);
  var max = parseFloat(slider.getAttribute("se-max") as string);

  // retrieve default values
  var defaultMinValue = min;
  if (slider.hasAttribute("se-min-value")) {
    defaultMinValue = parseFloat(slider.getAttribute("se-min-value") as string);
  }
  var defaultMaxValue = max;

  if (slider.hasAttribute("se-max-value")) {
    defaultMaxValue = parseFloat(slider.getAttribute("se-max-value") as string);
  }
  ...
  if (slider.getAttribute("se-step")) {
    step = Math.abs(parseFloat(slider.getAttribute("se-step") as string));
  }
